...
//
//  Created by Sergei Alekeyevich Kim (Alias. Son Phan) on 9/2/20.
...
let player = SKSpriteNode(imageNamed: "playerShip")
    ...
    // Lines 60-77 has to do with the screen and the resolution
var gameArea: CGRect
    ...
    // These lines have something to do with the screen as well (91-106)
    func random() -> CGFloat {
    ...
    override func didMove(to view: SKView) {
        ...
        //You lose an attempt everytime a ship goes down the screen
        livesLabel.text = "Attempts: 3"
    ...
    // After a given amount of points (line 237), increase the level
    func startNewLevel() {
